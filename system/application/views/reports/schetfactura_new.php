...
if (strlen($data_schet)==0){ echo datetostringg($schetfactura_date->date);} else { echo $data_schet;}?>
 </td>
 ...
 <tr>
 <td width=2100px>Тауарлар (жұмыстар, қызметтер) жеткізуге арналған шарт (келісім-шарт)<br/>Договор(контракт) на поставку товаров (работ, услуг) №<u>   <?php echo $firm->dogovor."   </u> от <u>    ".datetostringg($firm->dogovor_date);?></u></td>
 <td> (3)</td>
 </tr>
 <tr>
 ...
 <tr>
 <td width=2100px>Жүк жіберуші<br/> Грузоотправитель <u><?php if (strlen($firm->edit5)==0) {echo "БИН ".$org->bin.", ".$org->org_name.", ".$org->address;} else echo $firm->edit5;?>                                                                                                                   </u></td>
 <td> (8)</td>
 </tr>
 <tr align=right>
 ...
 <tr>
 <td width=2100px>Алушының ЖСК<br/> ИИК получателя<u>   <?php IF (strlen($firm->edit7)==0) { echo $firm->raschetnyy_schet;?></u> в банке <u><?php echo $bank->name;} else echo $firm->edit7;?></u></td>
 <td> (10б)</td>
 </tr>
 </table>
 <br>
...
<tr align="center">
	...
	<TD width="400px">Электроэнергия за <?php echo datetostring2($schetfactura_date->date);?> года </td>
...
<br />
 ...
 <tr>
 <td width=2100px><b>Уполномоченный на подписание счет-фактуры</b>  </td></tr>
 <tr>
 <td width=2100px><b>за руководителя  ____________________</b>  </td></tr>
 <tr>
 <td ><b>гл. бухгалтера  ____________________</b>  </td></tr>
 <tr align=left>
